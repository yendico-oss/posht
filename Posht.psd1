...
FunctionsToExport = @("Get-ApiCollection", "Get-ApiRequest", "Show-ApiRequest", "Update-ApiCollectionBaseUri", "Update-ApiCollectionHeaders", "Invoke-ApiRequest", "Remove-ApiRequest", "Remove-ApiCollection", "Get-ApiSessionCookies", "Clear-ApiSession")
